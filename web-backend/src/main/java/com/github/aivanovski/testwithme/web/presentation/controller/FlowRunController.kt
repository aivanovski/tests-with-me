...
import com.github.aivanovski.testwithme.web.api.response.FlowRunResponse
...
import com.github.aivanovski.testwithme.web.entity.exception.InvalidRequestFieldException
...
class FlowRunController(
    ...
    fun getFlowRuns(
        user: User
    ): Either<AppException, FlowRunsResponse> = either {
    ...
    fun getFlowRun(
        user: User,
        flowRunUid: String
    ): Either<AppException, FlowRunResponse> = either {
    ...
    ): Either<AppException, PostFlowRunResponse> = either {
