...
class ApiClient(
    ...
    suspend fun getGroups(): Either<ApiException, List<Group>> = either {
    ...
    ): Either<ApiException, PostFlowResponse> = either {
        val body = json.encodeToString(request)
    ...
    ): Either<ApiException, PostProjectResponse> = either {
        val body = json.encodeToString(request)
    ...
    suspend fun getProjects(): Either<ApiException, List<ProjectEntry>> = either {
