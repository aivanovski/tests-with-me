...
import com.github.aivanovski.testswithme.android.presentation.core.cells.ui.newUnshapedChipRowCell
            ...
            Column(
                ...
                if (state.users != null) {
                    Box(
                        ...
                        CreateCoreCell(viewModel = state.users)
                    }
                }
...
private fun LoginState(
    ...
    Column(
        modifier = Modifier
            .padding(horizontal = GroupMargin)
    ) {
